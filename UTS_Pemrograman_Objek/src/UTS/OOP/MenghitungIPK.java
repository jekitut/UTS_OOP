...
public class MenghitungIPK {
    ...
    public static void main(String[] args) {
        String nama, semester, jurusan, predikat;
        int nilaioop, nilaibd, nilaijk, ip, totalnilaimk;
